...
void QuadEstimatorEKF::UpdateFromIMU(V3F accel, V3F gyro)
{
  ...
  // Rotatin Matrix ( from Control/Lesson 4:Full 3D Control/3D Drone Exercise)
  float phi = rollEst;
...
VectorXf QuadEstimatorEKF::PredictState(VectorXf curState, float dt, V3F accel, V3F gyro)
{
  ...
  // From "Estimation for Quadrotors" paper ( Eq. 48, 49 )
...
void QuadEstimatorEKF::UpdateFromGPS(V3F pos, V3F vel)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
  // From "Estimation for Quadrotors" paper ( 7.3.1 GPS )
  zFromX(0) = ekfState(0);
  zFromX(1) = ekfState(1);
  zFromX(2) = ekfState(2);
  zFromX(3) = ekfState(3);
...
void QuadEstimatorEKF::UpdateFromMag(float magYaw)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
  // From "Estimation for Quadrotors" paper ( 7.3.2 Magnetometer )
  zFromX(0) = ekfState(6);
